      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Schedule and send emails at scale with intelligent rate limiting
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 space-y-3">
              <Feature text="Schedule emails with custom delays" />
              <Feature text="Upload CSV for bulk sending" />
              <Feature text="Hourly rate limiting" />
